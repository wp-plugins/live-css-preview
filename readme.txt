...
1. The Live CSS section will be added to the Customize screen (added in WP 3.4).
2. Links to the Customize screen can be found on the Appearance>Themes page as well as under the front-end admin bar (if available).
